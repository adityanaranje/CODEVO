...
def fetch_github_repo(owner, repo, branch, extensions, github_token):
    """
    Fetch all files from a GitHub repo branch that match the given extensions,
...
def get_github_branches(owner, repo, github_token):
    """
    Fetch all branches of a GitHub repo using the provided GitHub token.
    Raises an exception if fetch fails.
    """
